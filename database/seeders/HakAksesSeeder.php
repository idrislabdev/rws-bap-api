...
class HakAksesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $items = [
            ...
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.starclick_ncx', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.starclick_ncx.pengajuan', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.starclick_ncx.pengajuan.create', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.starclick_ncx.pengajuan.approve', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.starclick_ncx.history', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.ncx_cons', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.ncx_cons.pengajuan', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.ncx_cons.pengajuan.create', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.ncx_cons.pengajuan.approve', 'deskripsi' => '-'],
            ['id' => Uuid::uuid1()->toString(), 'nama' => 'account_center.ncx_cons.history', 'deskripsi' => '-'],
