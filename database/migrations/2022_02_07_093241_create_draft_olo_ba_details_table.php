...
class CreateDraftOloBaDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('draft_olo_ba_details', function (Blueprint $table) {
            $table->string('olo_ba_id', 100);
            $table->integer('id');
            $table->foreign('olo_ba_id')->references('id')->on('draft_olo_bas')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('draft_olo_ba_details');
    }
}
