...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Fronthaul | {{ $data_ba->no_dokumen }}</title>
    ...
    <body>
        ...
        <main>
            <div class="page_break_after">
                ...
                <div class="header">
                    <h3 class="header-margin font-weight-bold"><center>BERITA ACARA UJI TERIMA (BAUT) FRONTHAUL AKSES LINK</center></h3>
                ...
                <div class="margin-content margin-body">
                    <table>
                        ...
                        <tr>
                            <td style="width:288px">Jumlah Site / Jarak</td>
                            <td style="width:10px">:</td>
                            <td>{{$total_site}} Akses Link dengan BW {{$total_jarak_m}} Meter</td>
                        </tr>
                    </table>
                </div>
                <div class="margin-content margin-body">
                                ...
                                <table class="table-kelengkapan cellpadding="0" cellspacing="0">
                                    <tbody>
                                        ...
                                        @for ($b=$a; $b<=$a+1; $b++)
                                            @if ($b <= @count($data_site))
                                                <tr>
                                                    <td colspan="2" style="text-align: left !important; font-weight:bold;">Data OTDR Site {{$data_site[$b-1]->site_id}}</td>
                                                </tr>
                                                <tr>
                                                    <td width="5%"></td>
                                                    <td>
                                                        <img src="{{ public_path().'/lampirans/'. $data_site[$b-1]->otdr }}" style="width:700px; height:400px; object-fit: cover;">
                                                    </td>
                                                </tr>
                                            @endif
                                        @endfor
                            ...
                            <tbody>
                                ...
                                @else
                                    <tr>
                                        <td width="5%"></td>
                                        <td>
                                            <img src="{{ public_path().'/lampirans/'. $data_site[0]->topologi }}" style="width:700px; height:350px; object-fit: cover;">
                                        </td>
                                    </tr>
                                @endif
                                <tr>
                                ...
                                @else
                                    <tr>
                                        <td width="5%"></td>
                                        <td>
                                            <img src="{{ public_path().'/lampirans/'. $data_site[0]->trafik }}" style="width:700px; height:350px; object-fit: cover;">
                                        </td>
                                    </tr>
                                @endif
                                <tr>
                                    <td colspan="2" style="text-align: left !important; font-weight:bold;">Data OTDR Site {{$data_site[0]->site_id}}</td>
                                </tr>
                                @if($image[1] < 350)
                                    <tr style="height:350px;">
                                        <td width="5%"></td>
                                        <td>
                                            <img src="{{ public_path().'/lampirans/'. $data_site[0]->otdr }}" style="width:700px; object-fit: cover;">
                                        </td>
                                    </tr>
                                @else
                                    <tr>
                                        <td width="5%"></td>
                                        <td>
                                            <img src="{{ public_path().'/lampirans/'. $data_site[0]->otdr }}" style="width:700px; height:350px; object-fit: cover;">
                                        </td>
                                    </tr>
                                @endif
                            </tbody>
