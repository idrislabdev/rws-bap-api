...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Berita Acara Relokasi</title>
    ...
    <body>
        ...
        <main>
            <div class="page_break_after">
                ...
                <div class="header">
                    <h3 class="header-margin font-weight-bold"><center>BERITA ACARA UJI TERIMA (BAUT) RELOKASI AKSES LINK</center></h3>
