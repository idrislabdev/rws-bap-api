                                    ...
                                    @for ($b=$a; $b<=$a+2; $b++)
                                        @if ($b <= @count($data_site))
                                            ...
                                            <tr>
                                                <td width="5%"></td>
                                                <td>
                                                    <img src="{{ public_path().'/lampirans/'. $data_site[$b-1]->konfigurasi }}" style="width:600px; height:250px; object-fit: cover;">
                                                </td>
                                            </tr>
                                        @endif
                                    @endfor
                                        ...
                                        @for ($b=$a; $b<=$a+2; $b++)
                                            @if ($b <= @count($data_site))
                                                ...
                                                <tr>
                                                    <td width="5%"></td>
                                                    <td>
                                                        <img src="{{ public_path().'/lampirans/'. $data_site[$b-1]->topologi }}" style="width:600px; height:250px; object-fit: cover;">
                                                    </td>
                                                </tr>
                                            @endif
                                        @endfor
                                        ...
                                        @for ($b=$a; $b<=$a+2; $b++)
                                            @if ($b <= @count($data_site))
                                                ...
                                                <tr>
                                                    <td width="5%"></td>
                                                    <td>
                                                        <img src="{{ public_path().'/lampirans/'. $data_site[$b-1]->trafik }}" style="width:600px; height:250px; object-fit: cover;">
                                                    </td>
                                                </tr>
                                            @endif
                                        @endfor
                        ...
                        <table class="table-kelengkapan cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    <td width="5%"></td>
                                    <td>
                                        <img src="{{ public_path().'/lampirans/'. $data_site[0]->konfigurasi }}" style="width:600px; height:250px; object-fit: cover;">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="5%"></td>
                                    <td>
                                        <img src="{{ public_path().'/lampirans/'. $data_site[0]->topologi }}" style="width:600px; height:250px; object-fit: cover;">
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td width="5%"></td>
                                    <td>
                                        <img src="{{ public_path().'/lampirans/'. $data_site[0]->trafik }}" style="width:600px; height:250px; object-fit: cover;">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
